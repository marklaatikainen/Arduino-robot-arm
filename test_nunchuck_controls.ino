...
// map nunchuk data to a servo data point
  int x_axis = map(nunchuck_buf[0], 23, 222, 0, 180);
  int y_axis = map(nunchuck_buf[1], 32, 231, 180, 0);
  int accel_x_axis = map(nunchuck_buf[2], 75, 185, 180, 0); 
  int accel_y_axis = map(nunchuck_buf[3], 75, 185, 0,180); // * 2 * 2;
//  int accel_z_axis = nunchuck_buf[4]; // * 2 * 2;

//move servo to desired position based on Wii nunchuk reading
  servoLeft.write(accel_x_axis);
  servoRight.write(accel_y_axis);
